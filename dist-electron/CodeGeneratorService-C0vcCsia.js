import { C as ChatOpenAI, S as SystemMessage, H as HumanMessage } from "./main-k1z9y8hh.js";
import { domContextService } from "./DOMContextService-BEw_ijxb.js";
import "electron";
import "node:path";
import "node:fs";
import "node:url";
function getApiKey() {
  console.log("[CodeGeneratorService] Env key presence:", {
    NVIDIA_API_KEY: Boolean("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"),
    OPENAI_API_KEY: Boolean("")
  });
  return { key: "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", isNvidia: true };
}
