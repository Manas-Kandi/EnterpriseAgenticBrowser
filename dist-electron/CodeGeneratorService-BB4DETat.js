import { C as ChatOpenAI, S as SystemMessage, H as HumanMessage, d as dotenv } from "./main-D5EORDls.js";
import { domContextService } from "./DOMContextService-DyDh8RwP.js";
...
function findUp(startDir, filename, maxHops = 8) {
  ...
  for (let i = 0; i < maxHops; i++) {
    const candidate = path__default.join(dir, filename);
...
function ensureEnvLoaded() {
  ...
  const moduleDir = path__default.dirname(fileURLToPath(import.meta.url));
  const appPath = (() => {
    try {
