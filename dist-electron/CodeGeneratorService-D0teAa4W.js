import { C as ChatOpenAI, S as SystemMessage, H as HumanMessage, d as dotenv } from "./main-Dybb662Z.js";
import path__default from "node:path";
import { domContextService } from "./DOMContextService-BDGYaA4K.js";
dotenv.config({ path: path__default.join(process.cwd(), ".env") });
...
class CodeGeneratorService {
   ...
   */
  getModel(options = {}) {
    const apiKey = "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";
